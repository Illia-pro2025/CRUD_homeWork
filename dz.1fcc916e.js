...
function fetchStudent(id) {
    fetch(`${BASE_URL}/${id}`).then((resp)=>resp.json()).then((student)=>{
...
form.addEventListener("submit", (e)=>{
    ...
    if (!currentStudentId) addStudent(student);
    else updateStudent(currentStudentId, student);
    form.reset();
});
...
},{}]},["6zReE","fILKw"], "fILKw", "parcelRequirebe7a", {})

//# sourceMappingURL=dz.1fcc916e.js.map
